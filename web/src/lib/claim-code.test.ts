...
describe("validateClaimCode", () => {
  it("AC1.4: accepts standard valid codes", () => {
  ...
  it("AC1.4: trims whitespace and uppercases before validating", () => {
    expect(validateClaimCode("  AMBER-HAWK-7842  ")).toBe("AMBER-HAWK-7842");
    expect(validateClaimCode("amber-hawk-7842")).toBe("AMBER-HAWK-7842");
  });

  it("AC1.9: rejects codes missing the digit suffix", () => {
  ...
  it("AC1.9: rejects codes with wrong separator count", () => {
